declare @updateUser varchar(15) = 'la170111';
declare @BraskemProductGroupId int = (select PRODUCT_GROUP_ID from PRODUCT_GROUP where CODE = 'BRAS');
declare @UnitPriceSidId int = (select STORAGE_IDENTIFIER_ID from STORAGE_IDENTIFIER where CODE = 'UNITPRICE');
...
from PRODUCT_STORAGE_IDENTIFIER psi join PRODUCT_GROUP_PRODUCT pgp on psi.PRODUCT_ID = pgp.PRODUCT_ID and pgp.PRODUCT_GROUP_ID = @BraskemProductGroupId
...
INSERT INTO [dbo].[PRODUCT_STORAGE_IDENTIFIER]
	...
	WHERE pgp.PRODUCT_GROUP_ID = @BraskemProductGroupId
...
INSERT INTO [dbo].[PRODUCT_SID_OPERATION_TYPE]
	...
	WHERE psi.PRODUCT_ID = pgp.PRODUCT_ID and pgp.PRODUCT_GROUP_ID = @BraskemProductGroupId and psi.SID_ID = @UnitPriceSidId
...
WHERE sic.PRODUCT_ID = pgp.PRODUCT_ID and pgp.PRODUCT_GROUP_ID = @BraskemProductGroupId
