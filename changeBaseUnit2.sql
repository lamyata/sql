...
AS
	...
	declare @updateUser nvarchar(15) = 'la161027';
BEGIN
...
update ORDERS set INTERNAL_COMPANY_ID = 299 where ORDER_ID = 21890;
update STOCK_INFO_CONFIG
set INTERNAL_COMPANY_ID = 299,
		_KEY_ = dbo.SetKeyValue (_KEY_, '"IC":', '"', 299),
		HASH_KEY = CAST(hashbytes('SHA1', dbo.SetKeyValue (_KEY_, '"IC":', '"', 299)) AS BINARY(20)),	
		UPDATE_TIMESTAMP = GETDATE(),
		UPDATE_USER = 'la161027' 
 where STOCK_INFO_CONFIG_ID in (2469486, 2469487)			
