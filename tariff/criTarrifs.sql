...
declare @PeriodTo date = '30-SEP-2016';
declare @createUser nvarchar(15) = 'la161020'

--select * from TARIFF t join OPERATION o on t.OPERATION_ID = o.OPERATION_ID and o.CODE in ('WBB', 'DBBPLT', 'PECNT');
update t set PERIOD_TO = @PeriodTo, UPDATE_USER = @createUser, UPDATE_TIMESTAMP=GETDATE()
from TARIFF t join OPERATION o on t.OPERATION_ID = o.OPERATION_ID and o.CODE in ('WBB', 'DBBPLT', 'PECNT');

exec KreaAdditTar
	@TariffInfoCode = 'TWBB',
	@TariffInfoDescr = 'Weatherizing Big Bags',
	@TariffInfoTariff = 8,
	@UnitCode = 'BBG',
...
exec KreaAdditTar
	@TariffInfoCode = 'TDBBPLT',
	@TariffInfoDescr = 'De-stacking of Big Bags + re-palletize',
	@TariffInfoTariff = 8.1,
	@UnitCode = 'PAL',
	@MeasurementUnitDescription = null,
	@CurrencyCode = 'EUR',
	@OperationCode = 'DBBPLT',
	@CustomerCode = 'CRI',
	@ServiceAccount = '701380',
	@TariffFileReference = 'CRI_TARIFF',
	@createUser = @createUser
...
exec KreaAdditTar
	@TariffInfoCode = 'TPECNT',
	@TariffInfoDescr = 'Preparing export container (blocking/bracing)',
	@TariffInfoTariff = 6.25,
	@UnitCode = 'ORDER',
	@MeasurementUnitDescription = null,
	@CurrencyCode = 'EUR',
	@OperationCode = 'PECNT',
...
exec KreaAdditTar
	@TariffInfoCode = 'TRBBPLT',
	@TariffInfoDescr = 'Re-stacking of Big Bags + re-palletize',
	@TariffInfoTariff = 8.1,
	@UnitCode = 'PAL',
	@MeasurementUnitDescription = null,
	@CurrencyCode = 'EUR',
	@OperationCode = 'RBBPLT',
	@CustomerCode = 'CRI',
	@ServiceAccount = '701380',
	@TariffFileReference = 'CRI_TARIFF',
	@createUser = @createUser
...
exec KreaAdditTar
	@TariffInfoCode = 'TAOLIALBM',
	@TariffInfoDescr = 'Labelling IMO Labels',
	@TariffInfoTariff = 4.5,
	@UnitCode = 'LBL',
	@MeasurementUnitDescription = null,
	@CurrencyCode = 'EUR',
	@OperationCode = 'AOLIALBM',
	@CustomerCode = 'CRI',
	@ServiceAccount = '701380',
	@TariffFileReference = 'CRI_TARIFF',
	@createUser = @createUser
